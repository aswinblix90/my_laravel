<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            <x-dropdown>
                <x-slot name="trigger">
                    <button class="py-2 pl-3 pr-9 text-left lg:w-32 w-full text-sm font-semibold lg:inline-flex">
                        {{isset($currentCategory) ? ucwords($currentCategory->name) : 'Category'}}
                        <x-icon name="down-arrow" class="absolute pointer-events-none"  style="top: 10px;right: 12px;"></x-icon>
                    </button>
                </x-slot>
            ...
            {{-- <a href="/categories/{{$category->slug}}" 
                class="block text-left text-sm px-3 leading-6 
