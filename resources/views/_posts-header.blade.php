    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            <div x-data="{show: false}" @click.away="show=false">
                <button 
                    @click="show =!show" 
                    class="py-2 pl-3 pr-9 text-left lg:w-32 w-full text-sm font-semibold lg:inline-flex"
                >
                {{isset($currentCategory) ? ucwords($currentCategory->name) : 'Category'}}
                <svg class="transform -rotate-90 absolute pointer-events-none" style="top: 10px;right: 12px;" width="22"
